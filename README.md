...
* [RankGrasps.action](https://github.com/GT-RAIL/rail_grasp_calculation/blob/melodic-devel/rail_grasp_calculation_msgs/action/RankGrasps.action):
...
* [SampleGrasps.action](https://github.com/GT-RAIL/rail_grasp_calculation/blob/melodic-devel/rail_grasp_calculation_msgs/action/SampleGrasps.action):
...
* **Action Servers**
  * `rank_grasps_object`([rail_grasp_calculation_msgs/RankGraspsAction](https://github.com/GT-RAIL/rail_grasp_calculation/blob/melodic-devel/rail_grasp_calculation_msgs/action/RankGrasps.action))  
  ...
  * `rank_grasps_scene`([rail_grasp_calculation_msgs/RankGraspsAction](https://github.com/GT-RAIL/rail_grasp_calculation/blob/melodic-devel/rail_grasp_calculation_msgs/action/RankGrasps.action))  
  ...
  * `rank_grasps_poi`([rail_grasp_calculation_msgs/RankGraspsAction](https://github.com/GT-RAIL/rail_grasp_calculation/blob/melodic-devel/rail_grasp_calculation_msgs/action/RankGrasps.action))  
